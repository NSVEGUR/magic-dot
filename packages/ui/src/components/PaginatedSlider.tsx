...
const PaginatedSlider = (props: paginatedSliderProps) => {
  React.useEffect(() => {
    ...
    >
      <div className="slide  absolute inset-0 flex  h-full w-full items-center justify-center bg-black transition duration-1000">
        {props.slides.map((slide, i) => {
          return (
            <div
              className="slide  absolute inset-0 flex  h-full w-full items-center justify-center bg-black transition duration-1000"
              key={i}
            >
              {slide}
            </div>
